...
class PhotoPage7 extends StatefulWidget {
  const PhotoPage7({Key? key}) : super(key: key);

  @override
  State<PhotoPage7> createState() => _PhotoPageState();
}

class _PhotoPageState extends State<PhotoPage7> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("PhotoPage7"),),
    );
  }
}
