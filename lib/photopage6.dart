...
class PhotoPage6 extends StatefulWidget {
  const PhotoPage6({Key? key}) : super(key: key);

  @override
  State<PhotoPage6> createState() => _PhotoPageState();
}

class _PhotoPageState extends State<PhotoPage6> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("PhotoPage6"),),
    );
  }
}
