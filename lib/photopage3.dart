...
class PhotoPage3 extends StatefulWidget {
  const PhotoPage3({Key? key}) : super(key: key);

  @override
  State<PhotoPage3> createState() => _PhotoPageState();
}

class _PhotoPageState extends State<PhotoPage3> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("PhotoPage3"),),
    );
  }
}
