...
class PhotoPage4 extends StatefulWidget {
  const PhotoPage4({Key? key}) : super(key: key);

  @override
  State<PhotoPage4> createState() => _PhotoPageState();
}

class _PhotoPageState extends State<PhotoPage4> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("PhotoPage4"),),
    );
  }
}
