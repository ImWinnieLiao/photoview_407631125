...
class PhotoPage2 extends StatefulWidget {
  const PhotoPage2({Key? key}) : super(key: key);

  @override
  State<PhotoPage2> createState() => _PhotoPageState();
}

class _PhotoPageState extends State<PhotoPage2> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("PhotoPage2"),),
    );
  }
}
